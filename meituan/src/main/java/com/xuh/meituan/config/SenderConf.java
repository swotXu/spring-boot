...
@Configuration
@ComponentScan({"com.xuh.meituan"})
public class SenderConf {
    public static String TICKET_QUEUE = "ticket.queue";
    public static String TICKET_EXCHANGE = "ticket.exchange";
    public static String TICKET_ROUTEKEY = "ticket.routekey";
    /**
     * 创建抢票队列
     * @return
     */
